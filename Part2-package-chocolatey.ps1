<#
.SYNOPSIS
    Zweites Skript zur Installation eines neuen Windows Computer
.DESCRIPTION
    Dieses Modul verwendet den Packager chocolatey um Programme zu installieren. 
.NOTES
    File Name  : Part2 - package-chocolatey.ps1
    Author     : Peter Gyger - 
#>
